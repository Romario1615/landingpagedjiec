...
(function () {
    const translations = {
        es: {
            ...
            nav_logo_alt: "DJI Ecuador",
            nav_drones: "DRONES",
            nav_camaras: "CÁMARAS",
            nav_estabilizadores: "ESTABILIZADORES",
            nav_accesorios: "ACCESORIOS",
            nav_soporte: "SOPORTE",
            nav_3d_aria: "Experiencia 3D Interactiva — Alcance Avanzado",
            nav_comprar: "COMPRAR",
            ...
            // Experiencia 3D (upsell page)
            promo3d_kicker: "ALCANCE AVANZADO",
            promo3d_title: "Experiencia 3D Interactiva",
            promo3d_desc: "Gira, haz zoom y explora un dron DJI en 3D en tiempo real, directo en tu navegador. Sin apps, sin descargas.",
            promo3d_cta: "PROBAR EXPERIENCIA 3D",
            exp3d_page_title: "Experiencia 3D Interactiva | DJI Ecuador",
            exp3d_meta_description: "La misma tienda DJI Ecuador, con meteoritos 3D en WebGL que chocan contra las tarjetas, botones y secciones de la página.",
            exp3d_badge_premium: "EXPERIENCIA PREMIUM"
        },
        en: {
            ...
            nav_soporte: "SUPPORT",
            nav_3d_aria: "Interactive 3D Experience — Advanced Reach",
            nav_comprar: "SHOP",
            ...
            // 3D Experience (upsell page)
            promo3d_kicker: "ADVANCED REACH",
            promo3d_title: "Interactive 3D Experience",
            promo3d_desc: "Rotate, zoom and explore a DJI drone in real-time 3D, right in your browser. No apps, no downloads.",
            promo3d_cta: "TRY THE 3D EXPERIENCE",
            exp3d_page_title: "Interactive 3D Experience | DJI Ecuador",
            exp3d_meta_description: "The same DJI Ecuador store, with 3D WebGL meteors that crash into the page's cards, buttons and sections.",
            exp3d_badge_premium: "PREMIUM EXPERIENCE"
        }
    };
